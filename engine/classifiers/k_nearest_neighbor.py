...
class KNearestNeighbor(object):
    """A kNN classifier supporting Euclidean and Manhattan distances."""
    ...
    def compute_distances_two_loops(self, X, metric="l2"):
        """
        ...
        - dists: A numpy array of shape (num_test, num_train) where dists[i, j]
          ...
          point.
        - metric: Either "l2" for Euclidean distance or "l1" for Manhattan
          distance.
        """
    ...
    def compute_distances_no_loops(self, X):
        ...
        squared_dists = X_squared + train_squared - 2 * cross_term
    ...
    def predict_labels(self, dists, k=1):
        ...
        for i in range(num_test):
            ...
            closest_y = self.y_train[neighbor_indices].astype(int)
